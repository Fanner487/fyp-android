...
public class AttendingEventsViewerActivityTest {

    @Rule
    public ActivityTestRule<AttendingEventsViewerActivity> rule  = new ActivityTestRule<>(AttendingEventsViewerActivity.class);

    @Test
    public void testTextViewExistsCreate(){


        AttendingEventsViewerActivity activity = rule.getActivity();
